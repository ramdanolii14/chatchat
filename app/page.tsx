...
export default function HomePage() {
  ...
  function handleOpenProfile(friend: any) {
    console.log('✅ Open Profile:', friend)
  ...
  return (
    <div className="h-screen flex bg-gray-100">
      <div className="w-1/4 border-r bg-white">
        <LeftPanel onSelectFriend={handleSelectFriend} onOpenProfile={handleOpenProfile} />
      </div>
      <div className="flex-1 border-r bg-white">
        {activeFriend ? (
          <ChatPanel selectedFriend={activeFriend} onOpenProfile={handleOpenProfile} />
        ) : (
      ...
      <div className="w-1/4 bg-white">
        {showProfile && activeProfile ? (
          <ProfilePanel selectedUser={activeProfile} onClose={() => setShowProfile(false)} />
        ) : (
